...
module.exports = async (pluginConfig, context) => {
  ...
  if (githubUrl) {
    logger.log('? GH_TOKEN: %s ; GITHUB_TOKEN: %s', env.GH_TOKEN, env.GITHUB_TOKEN);
    logger.log('? GITHUB_API_URL: %s ; GH_URL: %s ; GITHUB_URL: %s', env.GITHUB_API_URL, env.GH_URL, env.GITHUB_URL);
    logger.log('? GH_PREFIX: %s ; GITHUB_PREFIX: %s', env.GH_PREFIX, env.GITHUB_PREFIX);
